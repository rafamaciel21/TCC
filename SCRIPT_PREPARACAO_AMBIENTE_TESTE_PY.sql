...
(4)
GO
INSERT INTO DBA.ESTOQUE_CADASTRO_LOCAL  (IDLOCALESTOQUE, IDEMPRESABAIXAEST)
VALUES(1, 1),
(2, NULL),
(3, NULL),
(4, NULL)
...
FROM 
	...
	DBA.EMPRESA E
WHERE 
	NOT EXISTS (SELECT 1 FROM DBA.PRODUTO_GRADE B WHERE B.IDSUBPRODUTO = P.IDSUBPRODUTO AND E.IDEMPRESA = B.IDEMPRESA)
